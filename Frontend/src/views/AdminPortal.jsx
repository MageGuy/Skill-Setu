...
const SCHEME_MATRIX = [
  {
    id: 'aicte',
    scheme: 'AICTE Model Curriculum Fast-Track 2025',
    tier: 'Tier-1 & Tier-2 Universities',
    nsqf: 'NSQF-8',
    enrolled: '1,12,000',
    certified: '88,400 Certified',
    placedRate: '78.9%',
    placedCount: '88,400 Placed',
    avgPackage: '₹8.40 LPA',
    topPackage: 'Top Tier: ₹21.0 LPA',
    roles: ['Full Stack Dev', 'Cloud Architect', 'DevSecOps'],
    recruiters: 'TCS Digital, Infosys, Tech Mahindra',
    recruiterMore: '+140 firms',
    color: '#006492'
  },
  {
    id: 'futureskills',
    scheme: 'FutureSkills Prime (NASSCOM + MeitY)',
    tier: 'Deep AI/ML Specialization',
    nsqf: 'NSQF-7',
    enrolled: '94,500',
    certified: '78,200 Certified',
    placedRate: '76.3%',
    placedCount: '72,100 Placed',
    avgPackage: '₹9.20 LPA',
    topPackage: 'Top Tier: ₹24.5 LPA',
    roles: ['AI/ML Engineer', 'Data Analyst', 'NLP Specialist'],
    recruiters: 'Innovaccer, LTIMindtree, Cognizant',
    recruiterMore: '+95 firms',
    color: '#D9822B'
  },
  {
    id: 'pmkvy',
    scheme: 'PMKVY Sovereign Cybersecurity & Cloud',
    tier: 'Defensive Sec & Infrastructure',
    nsqf: 'NSQF-6',
    enrolled: '86,000',
    certified: '72,500 Certified',
    placedRate: '71.1%',
    placedCount: '61,200 Placed',
    avgPackage: '₹6.50 LPA',
    topPackage: 'Top Tier: ₹15.8 LPA',
    roles: ['SecOps Trainee', 'Network Analyst', 'SOC L1'],
    recruiters: 'Wipro, HCLTech, Jio Platforms',
    recruiterMore: '+180 firms',
    color: '#006492'
  },
  {
    id: 'swayam',
    scheme: 'SWAYAM-NPTEL Deep Tech Bridges',
    tier: 'Semiconductors & Embedded',
    nsqf: 'NSQF-8',
    enrolled: '1,25,000',
    certified: '96,000 Certified',
    placedRate: '65.8%',
    placedCount: '82,300 Placed',
    avgPackage: '₹7.20 LPA',
    topPackage: 'Top Tier: ₹19.0 LPA',
    roles: ['Embedded Systems', 'VLSI Verification', 'Firmware Eng'],
    recruiters: 'Texas Instruments, Qualcomm, Bosch',
    recruiterMore: '+75 firms',
    color: '#102A43'
  }
];
...
export default function AdminPortal() {
  ...
  // Active view tabs: 'telemetry' (Macro Government Outcomes) vs 'roster' (Candidate Verification Table)
            ...
            <>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1.5rem' }}>
                  <div style={{ maxWidth: '820px' }}>
                    ...
                    <h1 style={{ fontSize: 'clamp(1.6rem, 2.5vw, 2.2rem)', fontWeight: 800, color: 'var(--text-main)', letterSpacing: '-0.025em', lineHeight: 1.25 }}>
                      Government Skilling Program Outcomes &amp; Institutional Impact
                    </h1>
                    <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.6, marginTop: '0.4rem' }}>
                      DPDP Act 2023 Compliant verified employment telemetrics across accredited technical universities and national industry consortia.
                    </p>
                  </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap', flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: '#FFFFFF', padding: '0.45rem 0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
                    ...
                    >
                      <option value="all">All Central Schemes (14 Active)</option>
              ...
              <section className="card" style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                  <span>Showing {filteredSchemes.length} of 14 Sovereign Schemes &bull; All 3,18,420 placement records backed by institutional verification hashes</span>
