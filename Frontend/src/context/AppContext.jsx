...
export function AppProvider({ children }) {
  ...
  const hydrateUserData = useCallback(
    ...
    [fetchProfile, fetchSkills, fetchTargetRoles, fetchCourses, fetchDrives, fetchDocuments, fetchAdminRoster, fetchAdminTelemetry]
  );
  ...
  const hydrateUser = useCallback(
    (user) => {
      ...
      const role = user?.role || 'student';
      setActiveTab(role === 'admin' ? 'admin-portal' : 'student-dashboard');
